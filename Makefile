...
help:
	...
	@echo "   iverilog mXsY       -> compile testbench for specific configuration"
	@echo "   sim mXsY            -> run simulation for specific configuration"
	@echo "   gtk mXsY            -> open waveform viewer for specific configuration"
	@echo "   clean               -> clean simulation files"
	@echo ""
	@echo "usage examples:"
	@echo "   make interconnect m2s2"
	@echo "   make iverilog m1s2"
	@echo "   make sim m1s2"
	@echo "   make gtk m1s2"